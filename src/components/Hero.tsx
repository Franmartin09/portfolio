            ...
            <div className="container mx-auto flex flex-col md:flex-row justify-center items-center md:items-center space-y-8 md:space-y-0 md:space-x-8 p-4">
                    ...
                    <div className="flex-col items-center bg-opacity-10 rounded-[10px] border-[1px] border-gray-200 w-[400px] p-4  bg-white bg-clip-border shadow-md shadow-[#F3F3F3] dark:border-[#ffffff33] dark:!bg-navy-800 dark:text-white dark:shadow-none">
                        <div className="relative flex justify-center rounded-xl bg-cover">
                            <img
                                ...
                                className="flex h-80 w-full justify-center rounded-xl bg-cover"
                                alt="Banner"
                            />
                        </div>
                        ...
                        <div className="flex items-center justify-around w-full space-x-8 mb-3">
                            {/* LINKEDIN */}
                            <div className="flex flex-col items-center">
                                <Link target="_blank" href="https://www.linkedin.com/in/fran-martin-ag" className="hover:underline">
                            ...
                            <div className="flex flex-col items-center justify-center">
                                <Link target="_blank" href="https://github.com/Franmartin09" className="hover:underline">
                                    <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {/* HUGGING FACE */}
                            <div className="flex flex-col items-center justify-center">
                                <Link target="_blank" href="https://huggingface.co/Franmartin09" className="hover:underline">
                                    <svg className="w-6 h-6 text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32"><g fill="currentColor">
                            ...
                            {/* MAIL */}
                            <div className="flex flex-col items-center justify-center">  
                                <Link target="_blank" href="mailto:franmartinaguilar@gmail.com" className="hover:underline">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" className="w-6 h-6 text-gray-800 dark:text-white">
                ...
                <div className="w-full md:w-1/2 text-center md:text-left flex justify-center md:justify-start">
                    <div>
                        ...
                        <div className="flex items-center justify-around w-full space-x-8 my-3">
                            <button className="flex flex-col items-center text-black dark:text-white rounded-[3px] border-[1px] border-gray-200 px-3 py-1">Contacta</button>
                            <button className="flex flex-col items-center text-black dark:text-white rounded-[4px] border-[1px] border-gray-200 px-3 py-1">Descargar CV</button>
                        </div>
                    </div>
                </div>
            </div>
